...
#include <stdbool.h>
#include <string.h>
#include "GameHouse.h" // Inclui a interface da nossa implementação
...
int main() {
    ...
    // Esta pré-condição agora deve ser implementada no GameHouse.c para funcionar
...
void setup_initial_state() {
    ...
    // Créditos (Corrigido para respeitar o MAX_CREDITOS = 3)
    GameHouse__comprar_creditos(CLIENTE_1, 2);
    GameHouse__comprar_creditos(CLIENTE_2, 3);
}
